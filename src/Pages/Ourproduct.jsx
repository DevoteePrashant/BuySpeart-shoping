  ...
  <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
    ...
    <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
      ...
      <div>
        ...
        <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Beauty Products</h2>
      </div>
    ...
    <div class="flex items-center gap-2">
      ...
      <h2 class="text-2xl font-bold text-gray-800 pt-2">Best Selling Products</h2>
    </div>
    ...
    <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        <div class="pt-6">
          ...
          <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Organizer for Mackup</a>
