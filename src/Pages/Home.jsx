...
import { FaFacebookF, FaTwitter, FaInstagram, FaLinkedin, FaLightbulb, FaRegLightbulb } from "react-icons/fa"; // Social Media Icons
import { Swiper, SwiperSlide } from "swiper/react"; // Import Swiper.js components
import "swiper/css"; // Import Swiper styles
import img from "../images/hero_endframe__cvklg0xk3w6e_large 2.png"
import img2 from "../images/1200px-Apple_gray_logo 1.png"
import img3 from "../images/JBL_BOOMBOX_2_HERO_020_x1 (1) 1.png"
import img4 from "../images/ps5-slim-goedkope-playstation_large 1.png"
import img5 from "../images/attractive-woman-wearing-hat-posing-black-background 1.png"
import img6 from "../images/652e82cd70aa6522dd785109a455904c.png"
import img7 from "../images/69-694768_amazon-echo-png-clipart-transparent-amazon-echo-png 1.png"
...
function Home() {
  return (
    <>
      <div className="flex flex-col md:flex-row bg-gray-100  mb-8" >
        {/* Sidebar */}
        <aside className="w-full md:w-1/4 bg-white shadow-lg p-6  md:h-screen" style={{ height: "625px" }}>
          <ul className="space-y-4 pt-20">
            <li className="flex justify-between items-center text-gray-800 font-medium">
              Kitchen Products <span>›</span>
            </li>
            <li className="flex justify-between items-center text-gray-800 font-medium">
              Beauty Products <span>›</span>
            </li>
            <li className="flex justify-between items-center text-gray-800 font-medium">
              Kids Products <span>›</span>
            </li>
            <li className="flex justify-between items-center text-gray-800 font-medium">
          ...
          <div className="mt-10 mb-20">
            <h3 className="text-gray-600 font-semibold mb-4">Follow us on</h3>
        ...
        <main className="w-full md:w-3/4 p-6" >
          ...
          >
            {/* Slide 1 */}
            <SwiperSlide>
              <div className="bg-black  overflow-hidden relative h-[300px] md:h-[500px] lg:h-[600px]">
                <img
                  src={img}
                  alt="Product Slide"
                  className="w-full h-full object-cover opacity-50"
                />
                <div className="absolute inset-0 flex flex-col md:flex-row justify-start items-center p-8 text-white gap-4">
                  <img
                    src={img2}
                    alt="Product Slide"
                    className="hidden md:block object-cover w-[150px] md:w-[200px]"
                  />
                  <div>
                    <h2 className="text-lg md:text-3xl lg:text-4xl font-bold pt-8 md:pt-24">iPhone 14 Series</h2>
                    <p className="mt-2 text-sm md:text-lg lg:text-xl">Up to 10% off Voucher</p>
                    <button className="mt-4 bg-white text-black px-6 py-2 rounded hover:bg-gray-200 transition-all">
                      <Link to="/Ourproduct">Shop Now →</Link>
                    </button>
                  </div>
                </div>
              </div>
          ...
          <div className="w-full bg-black text-white py-8">
            <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="flex justify-center mt-6">
                <div className="bg-black  rounded-lg overflow-hidden max-w-xl w-full">
                  <div className="flex flex-col sm:flex-row items-center">
                    {/* Text Section */}
                    <div className="p-6 sm:w-1/2 p-3">
                      <p className="text-sm text-blue-400 text-left">Categories</p>
                      <h3 className="text-3xl font-bold mt-2  text-left">Enhance Your Music Experience</h3>
                    ...
                    <div className="sm:w-1/2">
                      <img
                        src={img3} // Replace with your product image URL
                        alt="JBL Speaker"
 ...
 <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 p-6">
    {/* <!-- Left Feature Card --> */}
    <div class="relative bg-black text-white rounded-lg overflow-hidden shadow-lg group">
        <img src={img4} alt="PlayStation 5" class="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition duration-300" />
        <div class="absolute inset-0 p-6 flex flex-col justify-end bg-gradient-to-t from-black via-transparent to-transparent">
            <h2 class="text-xl lg:text-2xl font-semibold text-left">PlayStation 5</h2>
            <p class="text-sm lg:text-base mt-2 text-left">Black and White version of the PS5 coming out on sale.</p>
            <button class="mt-4 text-sm font-medium bg-white text-black px-4 py-2 rounded hover:bg-gray-200">Shop Now</button>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* <!-- Women's Collections --> */}
        <div class="relative bg-black text-white rounded-lg overflow-hidden shadow-lg group">
            <img src={img5} alt="Women's Collections" class="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition duration-300" />
            <div class="absolute inset-0 p-6 flex flex-col justify-end bg-gradient-to-t from-black via-transparent to-transparent">
                <h2 class="text-xl font-semibold text-left">Women's Collections</h2>
                <p class="text-sm mt-2 text-left">Featured women collections that give you another vibe.</p>
                <button class="mt-4 text-sm font-medium bg-white text-black px-4 py-2 rounded hover:bg-gray-200">Shop Now</button>
            </div>
        </div>
        ...
        {/* <!-- Speakers --> */}
        <div class="relative bg-black text-white rounded-lg overflow-hidden shadow-lg group">
            <img src={img7} alt="Speakers" class="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition duration-300" />
            <div class="absolute inset-0 p-6 flex flex-col justify-end bg-gradient-to-t from-black via-transparent to-transparent">
                <h2 class="text-xl font-semibold text-left">Speakers</h2>
                <p class="text-sm mt-2 text-left">Amazon wireless speakers.</p>
                <button class="mt-4 text-sm font-medium bg-white text-black px-4 py-2 rounded hover:bg-gray-200">Shop Now</button>
            </div>
        </div>

        {/* <!-- Perfume --> */}
        <div class="relative bg-black text-white rounded-lg overflow-hidden shadow-lg group lg:ml-40" style={{width:"100%"}}>
            <img src={img6} alt="Perfume" class="w-full h-full object-cover opacity-70 group-hover:opacity-100 transition duration-300" />
            <div class="absolute inset-0 p-6 flex flex-col justify-end bg-gradient-to-t from-black via-transparent to-transparent w-100">
                <h2 class="text-xl font-semibold text-left">Perfume</h2>
                <p class="text-sm mt-2 text-left">GUCCI INTENSE OUD EDP.</p>
                <button class="mt-4 text-sm font-medium bg-white text-black px-4 w-34 py-2 rounded hover:bg-gray-200">Shop Now</button>
            </div>
        </div>
    </div>
</div>
...
<div className="flex flex-wrap justify-center items-center py-10 bg-white">
  {/* Free and Fast Delivery */}
<div className="text-center mx-6 w-full sm:w-1/3 px-4">
    <div className="flex justify-center items-center w-16 h-16 bg-gray-200 rounded-full mb-4 mx-auto">
    ...
    <p className="text-sm text-gray-600">Free delivery for all orders over ₹499</p>
</div>
